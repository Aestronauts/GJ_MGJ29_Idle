...
namespace OD {
    public class AtmosphericFogRenderFeature : ScriptableRendererFeature {
        class CustomRenderPass : ScriptableRenderPass{
            ...
            {
                cmd.GetTemporaryRT(tempTexture.rtHandleProperties.GetHashCode(), cameraTextureDescriptor);
            }
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData){
                ...
                cmd.Blit(source, tempTexture.nameID, material, 0);
                cmd.Blit(tempTexture.nameID, source);
